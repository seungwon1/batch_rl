...
class dqn_solver(object):
    ...
    def __init__(self, env, train_step, loss, num_actions, variable, var2, sess, mini_batch, train_start, target_reset, max_episodes, epsilon, epsilon_decay, gamma, memory_capa, pkg1, pkg2, arch, print_every = 100, eval_every = 50, verbose = True):
